...
This project was built from a MERN Starter kit (original URLs broken). Discussions still [active here](https://hashnode.com/n/mern). MERN is Mongo, Express, React and NodeJS.I modified this readme file by typing the text you are currently seeing on your screen.
